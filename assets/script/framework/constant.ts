...
export class Constant {
    ...
    //资源文件下的文件名
    public static RESOURCES_FILE_NAME = {
        AUDIO: 'audio',//音频
        DATA: 'datas',//配置表
        PREFAB: 'prefab',//预制体
    ...
    //音频文件下分类
    public static AUDIO_FILE_NAME = {
        MUSIC: 'music',//bgm
        SOUND: 'sound',//音效
    }

    //预制体文件下分类
    public static PREFAB_FILE_NAME = {
        UI: 'ui',//ui
        EFFECT: 'effect',//特效
        MODEL: 'model',//模型
    }
    ...
    //获取角色技能表名称
    static playerSkillName () {
        //@ts-ignore
        return this.PLAYER_SKILL_CSV_NAME[i18n._language];
    }

    //角色技能表名称
    public static PLAYER_SKILL_CSV_NAME = {
        'zh': 'playerSkill',
        'en': 'playerSkillEn'
    }
